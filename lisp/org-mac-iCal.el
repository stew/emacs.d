...
the the Emacs diary"
  ...
  (setq local-calendars (append (directory-files "~/Library/Calendars" 1 ".*calendar$")
				 (mapcan (lambda (dir) (directory-files dir 1 ".*calendar$"))
					(directory-files "~/Library/Calendars" 1 ".*exchange$"))))
  ...
  (setq all-calendars (delq 'nil (mapcar 'omi-checked all-calendars)))
